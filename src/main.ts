...
const THEME_META: Record<ThemeId, ThemeMeta> = {
  ...
  'НАРРАТИВ': { icon: '📚', label: 'НАРРАТИВ', sample: 'История-утро и мысль-образ. Между голос-тон…', expansion: 15.8, group: 'texts' },
  'ГОРОД':  { icon: '🏙️', label: 'ГОРОД', sample: 'Город-утро и район-центр. Потом улица-дорога…', expansion: 13.4, group: 'texts' },
  'РАБОТА': { icon: '💼', label: 'РАБОТА', sample: 'Проект-старт и задача-приоритет. Также встреча-итог…', expansion: 14.2, group: 'texts' },
  'ДОМ':    { icon: '🏠', label: 'ДОМ', sample: 'Дом-уют и кухня-вкус. Ещё комната-порядок…', expansion: 12.9, group: 'texts' },
  'ПУТЕШЕСТВИЕ': { icon: '🧳', label: 'ПУТЕШЕСТВИЕ', sample: 'Поездка-старт и маршрут-фото. Потом билет-терминал…', expansion: 15.1, group: 'texts' },
  'ПОГОДА': { icon: '🌦️', label: 'ПОГОДА', sample: 'Погода-утро и ветер-порыв. А дождь-капля…', expansion: 13.6, group: 'texts' },
  'КУЛИНАРИЯ': { icon: '🍲', label: 'КУЛИНАРИЯ', sample: 'Рецепт-вкус и кухня-аромат. Да тесто-корочка…', expansion: 14.7, group: 'texts' },
