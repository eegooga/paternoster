...
const THEME_META: Record<ThemeId, ThemeMeta> = {
  ...
  'ГОРОД':  { icon: '🏙️', label: 'ГОРОД', sample: 'Городутро и районцентр. Потом улицадорога…', expansion: 13.4, group: 'texts' },
  'РАБОТА': { icon: '💼', label: 'РАБОТА', sample: 'Проектстарт и задачаприоритет. Также встречаитог…', expansion: 14.2, group: 'texts' },
  'ДОМ':    { icon: '🏠', label: 'ДОМ', sample: 'Домуют и кухнявкус. Ещё комнатапорядок…', expansion: 12.9, group: 'texts' },
  'ПУТЕШЕСТВИЕ': { icon: '🧳', label: 'ПУТЕШЕСТВИЕ', sample: 'Поездкастарт и маршрутфото. Потом билеттерминал…', expansion: 15.1, group: 'texts' },
  'ПОГОДА': { icon: '🌦️', label: 'ПОГОДА', sample: 'Погодаутро и ветерпорыв. А дождькапля…', expansion: 13.6, group: 'texts' },
  'КУЛИНАРИЯ': { icon: '🍲', label: 'КУЛИНАРИЯ', sample: 'Рецептвкус и кухняаромат. Да тестокорочка…', expansion: 14.7, group: 'texts' },
