...
const GOROD: Theme = {
  ...
  words: makeWords16x16(
    ['тихий','шумный','ранний','поздний','новый','старый','дальний','ближний','северный','южный','ночной','утренний','дворовый','районный','центральный','пешеходный'],
    ['маршрут','переход','проспект','квартал','дворик','сквер','бульвар','переулок','перрон','подъезд','фонарь','тротуар','поток','поворот','вокзал','перекрёсток'],
    '-',
  ),
} as const;
...
const RABOTA: Theme = {
  ...
  words: makeWords16x16(
    ['срочный','плановый','финальный','ежедневный','утренний','вечерний','командный','личный','ключевой','рабочий','короткий','длинный','точный','быстрый','тихий','общий'],
    ['созвон','бриф','дедлайн','отчёт','протокол','черновик','комментарий','релиз','приоритет','вопрос','ответ','график','итог','статус','архив','согласование'],
    '-',
  ),
} as const;
...
const DOM: Theme = {
  ...
  words: makeWords16x16(
    ['тёплый','уютный','тихий','светлый','поздний','ранний','семейный','домашний','чистый','мягкий','долгий','короткий','обычный','вкусный','ленивый','спокойный'],
    ['вечер','завтрак','ужин','плед','диван','чайник','балкон','коридор','подъезд','список','порядок','посуда','кастрюля','выпечка','тишина','выходной'],
    '-',
  ),
} as const;
...
const TRAVEL: Theme = {
  ...
  words: makeWords16x16(
    ['ранний','поздний','дальний','ближний','горный','морской','дорожный','ночной','утренний','летний','зимний','быстрый','спокойный','короткий','долгий','новый'],
    ['перелёт','переезд','маршрут','терминал','вокзал','перрон','багаж','чемодан','отель','бронь','экскурсия','панорама','привал','закат','открытка','сувенир'],
    '-',
  ),
} as const;
...
const POGODA: Theme = {
  ...
  words: makeWords16x16(
    ['ясный','пасмурный','ветреный','дождливый','снежный','тёплый','холодный','утренний','вечерний','ночной','летний','зимний','весенний','осенний','тихий','резкий'],
    ['прогноз','горизонт','ветер','дождь','снег','туман','гроза','рассвет','закат','осадки','градус','фронт','штиль','порыв','облако','прохлада'],
    '-',
  ),
} as const;
...
const KULINARIYA: Theme = {
  ...
  words: makeWords16x16(
    ['домашний','свежий','пряный','нежный','сытный','лёгкий','горячий','хрустящий','утренний','вечерний','праздничный','быстрый','долгий','яркий','мягкий','густой'],
    ['рецепт','бульон','соус','салат','гарнир','маринад','десерт','выпечка','корочка','нарезка','сервировка','тарелка','духовка','сковорода','аромат','подача'],
    '-',
  ),
} as const;
