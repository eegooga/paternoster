...
const TRAVEL: Theme = {
  ...
  words: (
    ...
    // существительные: транспорт
    + 'самолёт поезд автобус метро трамвай такси паром лайнер катер корабль машина велосипед самокат кабина терминал '
    // существительные: локации
    + 'аэропорт станция платформа причал порт набережная площадь проспект бульвар улица квартал район центр окраина курорт '
    // существительные: документы
    + 'паспорт виза страховка регистрация маршрутка расписание табло посадочный бронеписьмо подтверждение квитанция багажник рюкзак кошелёк навигатор адаптер '
    // прилагательные: дорога
    + 'дальний ближний быстрый медленный прямой круговой ночной дневной ранний поздний утренний вечерний скорый местный международный внутренний '
    // прилагательные: впечатления
    + 'яркий тихий шумный уютный просторный тесный солнечный дождливый ветреный снежный тёплый прохладный ясный облачный зелёный каменный '
    // прилагательные: сервис
    + 'удобный комфортный бюджетный дорогой надёжный безопасный вежливый точный гибкий понятный подробный краткий свободный занятый полный пустой '
    // прилагательные: ориентиры
    + 'исторический современный культурный природный морской горный лесной городской деревенский центральный окраинный северный южный западный восточный прибрежный '
    // глаголы: передвижение
    + 'ехать лететь плыть идти бежать выезжать приезжать отправляться прибывать пересаживаться поворачивать останавливаться ускоряться замедляться обходить пересекать '
    // глаголы: организация
    + 'планировать бронировать покупать заказывать оплачивать подтверждать переносить отменять проверять уточнять сравнивать выбирать сохранять загружать распечатывать сканировать '
    // глаголы: взаимодействие
    + 'спрашивать отвечать подсказывать звонить писать читать слушать переводить объяснять договариваться встречать провожать благодарить приветствовать улыбаться прощаться '
    // глаголы: быт
    + 'заселяться выселяться отдыхать гулять фотографировать наблюдать пробовать готовить упаковывать распаковывать стирать заряжать подключать ремонтировать искать находить '
    // абстрактные существительные
    + 'темп ритм график маршрутность навигация координация логистика траектория дистанция перспектива панорама динамика стабильность гибкость автономность точность '
    // эмоции и состояния
    + 'радость восторг спокойствие тревога интерес любопытство вдохновение усталость бодрость уверенность ожидание терпение внимание ностальгия воодушевление удовлетворение '
    // временные маркеры
    + 'утро вечер день ночь рассвет закат сегодня завтра вчера будни выходные понедельник пятница неделя месяц сезон '
    // городы и ориентиры
    + 'музей театр галерея собор крепость башня мост парк пляж рынок кафе ресторан гостиница аптека библиотека акведук обсерватория маяк '
  ),
} as const;
